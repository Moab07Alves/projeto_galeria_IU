...
import ui.GuiTelaPreencherDadoFoto;
...
public class Main {
    ...
    public static void main(String[] args){
       ...
       GuiLogin telaLogin = new GuiLogin(new GerenciadorUsuarios());
       telaLogin.run();

        //GuiSelecionarFotos tela = new GuiSelecionarFotos(usuario, galeria);
        //tela.run();
