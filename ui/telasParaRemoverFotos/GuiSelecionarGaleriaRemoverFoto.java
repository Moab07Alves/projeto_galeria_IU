...
import ui.telasParaVisualizarFotos.GuiSelecionarFotosVisualizar;

public class GuiSelecionarGaleriaRemoverFoto extends JFrame{
...
// --------------------------------------------------------------------------------------------
    ...
    public GuiSelecionarGaleriaRemoverFoto(GerenciadorUsuarios gerenciador, Usuario usuario) throws Exception {
    ...
    private void definirEventos() {
        ...
        jbEscolher.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e){
                ...
                try {
                    GuiSelecionarFotosRemover telaSelecionarFotosRemover;
                    telaSelecionarFotosRemover = new GuiSelecionarFotosRemover(gerenciador, usuario, tituloGaleriaSelecionada);
                    telaSelecionarFotosRemover.run();
                    dispose();
                } catch (Exception x) {
